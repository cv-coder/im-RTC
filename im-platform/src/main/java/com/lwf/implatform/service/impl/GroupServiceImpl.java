package com.lwf.implatform.service.impl;
...
import com.lwf.imcommon.util.CommaTextUtils;
import com.lwf.implatform.contant.Constant;
import com.lwf.implatform.contant.RedisKey;
import com.lwf.implatform.dto.GroupInviteDTO;
import com.lwf.implatform.dto.GroupMemberRemoveDTO;
import com.lwf.implatform.entity.*;
...
import com.lwf.implatform.mapper.GroupMapper;
import com.lwf.implatform.mapper.GroupMessageMapper;
import com.lwf.implatform.service.FriendService;
import com.lwf.implatform.service.GroupMemberService;
import com.lwf.implatform.service.GroupService;
...
import com.lwf.implatform.vo.GroupMemberVO;
import com.lwf.implatform.vo.GroupMessageVO;
import com.lwf.implatform.vo.GroupVO;
...
public class GroupServiceImpl extends ServiceImpl<GroupMapper, Group> implements GroupService {
    ...
    public List<GroupVO> findGroups() {
        ...
        return groups.stream().map(group -> {
            GroupMember member = groupMembers.stream().filter(m -> group.getId().equals(m.getGroupId())).findFirst()
                    .get();
            return convert(group, member);
    ...
    public void invite(GroupInviteDTO dto) {
        ...
        List<GroupMember> groupMembers = friends.stream().map(f -> {
            Optional<GroupMember> optional = members.stream().filter(m -> m.getUserId().equals(f.getFriendId()))
                    .findFirst();
