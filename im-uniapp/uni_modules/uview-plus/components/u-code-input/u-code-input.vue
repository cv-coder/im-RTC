<template>
	<view class="u-code-input">
		<view class="u-code-input__item" :style="[itemStyle(index)]" v-for="(item, index) in codeLength" :key="index">
		...
		<input :disabled="disabledKeyboard" type="number" :focus="focus" :value="inputValue" :maxlength="maxlength"
			:adjustPosition="adjustPosition" class="u-code-input__input" @input="inputHandler" :style="{
				height: addUnit(size)
 ...
 * @property {String}			mode				显示模式，box-LWF模式，line-底部横线模式 （默认 'box' ）
